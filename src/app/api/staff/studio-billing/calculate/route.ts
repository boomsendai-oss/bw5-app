...
import { recalcStudioBilling } from '@/lib/monthlyClose';

export const dynamic = 'force-dynamic';
export const runtime = 'nodejs';
export const maxDuration = 60;

// POST /api/staff/studio-billing/calculate { year_month: 'YYYY-MM' }
...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json(await recalcStudioBilling(ym));
}
