...
export async function POST(req: NextRequest) {
  ...
  const cols = ['name','name_kana','contact_email','contact_phone','instagram_handle','profile_text','profile_photo_url','shared_folder_url','bank_name','bank_branch','bank_account_type','bank_account_number','bank_account_holder','notes','slug','genre','crews','career_text','public_display_order','video_url'];
