...
export function getSchemaStatements(): InStatement[] {
  return [
    ...
    { sql: 'CREATE INDEX IF NOT EXISTS idx_survey_questions_survey ON survey_questions(survey_id, sort_order)', args: [] },
    { sql: 'CREATE INDEX IF NOT EXISTS idx_survey_responses_survey ON survey_responses(survey_id)', args: [] },
    { sql: 'CREATE INDEX IF NOT EXISTS idx_survey_responses_member ON survey_responses(boom_member_id)', args: [] },
    { sql: 'CREATE INDEX IF NOT EXISTS idx_survey_answers_response ON survey_answers(response_id)', args: [] },
    { sql: 'CREATE INDEX IF NOT EXISTS idx_survey_answers_question ON survey_answers(question_id, option_key)', args: [] },
    {
    ...
    {
      sql: `CREATE TABLE IF NOT EXISTS tshirt_orders (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      edit_token TEXT NOT NULL UNIQUE,
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_tshirt_orders_created ON tshirt_orders (created_at)`,
      args: [],
    },
    {
      sql: `CREATE TABLE IF NOT EXISTS tshirt_order_settings (
      id INTEGER PRIMARY KEY,
    ...
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_sales (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      name TEXT NOT NULL,
    ...
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_products (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_products_sale ON kiosk_products (sale_id)`,
      args: [],
    },
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_product_variants (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_variants_product ON kiosk_product_variants (product_id)`,
      args: [],
    },
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_orders (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      sale_id INTEGER NOT NULL,
      payment_method TEXT NOT NULL,
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_orders_session ON kiosk_orders (stripe_session_id)`,
      args: [],
    },
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_orders_status ON kiosk_orders (status)`,
      args: [],
    },
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_order_items (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      order_id INTEGER NOT NULL,
      product_id INTEGER NOT NULL,
      variant_id INTEGER,
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_order_items_order ON kiosk_order_items (order_id)`,
      args: [],
    },
    {
      sql: `CREATE TABLE IF NOT EXISTS kiosk_payments (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      stripe_event_id TEXT NOT NULL UNIQUE,
      event_type TEXT NOT NULL,
      stripe_session_id TEXT NOT NULL DEFAULT '',
    ...
    {
      sql: `CREATE INDEX IF NOT EXISTS idx_kiosk_payments_session ON kiosk_payments (stripe_session_id)`,
      args: [],
    },
  ];
}
