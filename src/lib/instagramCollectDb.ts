...
// フォーム冒頭の説明文。**用途(メンションすること)をここで伝え、送信をもって同意とみなす設計**
// (TARO 2026-08-17「厳密にしゃべりすぎると逆に不安を煽る。もうちょいシンプルに」)。
// 同意のはい/いいえを別途聞かないのは、聞くと「ものものしくなって怖い」ため。
// ＝この棚に入っている＝メンションOK。やめたくなったら本人が取り消す(棚から消える)。
export const DEFAULT_INTRO_MD = [
  '今後BOOMでは、リールやイベントの投稿など、各種SNSの発信をする際に、会員のみなさんをメンションさせていただければと思っています。',
  '',
  'ご協力いただける方は、Instagramのアカウント名を教えてください。',
  '',
  'もちろん任意です。アカウントを知られたくない方は、そのままで大丈夫です。登録したあとで気が変わったときは、いつでも取り消せます。',
].join('\n');
