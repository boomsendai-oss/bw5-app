...
## ジャンル
HIPHOP / ストリートジャズ / HOUSE / ガールズHIPHOP / WAACK / フリースタイル / NEW JACK SWING。ブレイキンはワークショップ実施済みでレギュラークラスを今年中に開講予定。**K-POPはやっていない**(聞かれたら正直に書く)。理由まで書く場合はこの筋で: K-POPはダンスのジャンルではなく音楽のジャンル。「K-POPダンス」の中身はHIPHOPやジャズなど既存ジャンルの技術でできている。BOOMはその中身(一つ手前の本質)を基礎から教えているので「K-POP」と看板を掲げない。K-POPをうまく踊りたいならHIPHOPもジャズもちゃんと踊れる必要がある。K-POPを否定しない・敵対的に書かない(役割が違うだけ): K-POPの曲で踊ること自体が目的ならK-POP専門を探すのが良い、「K-POPを上手に踊りたい」ならBOOMも選択肢のひとつ、という柔らかい着地(TARO 2026-09-09)。
